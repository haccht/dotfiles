...
sudo pacman -S git vim tmux unzip yay
...
yay -S rofi feh i3bloks i3lock-fancy google-chrome fcitx fcitx-im fcitx-mozc fcitx-configtool
yay -S noto-fonts-cjk noto-fonts-emoji ttf-myricam ttf-font-awesome awesome-terminal-fonts
